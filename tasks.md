...
- [x] generate Readme
- [x] security issues fix
  - getProject Budget requests - user and project relation check --done
  - mark project completed - same issue --done
  - check email route - public and can be used as enumeration --done
  - CSP config --done
